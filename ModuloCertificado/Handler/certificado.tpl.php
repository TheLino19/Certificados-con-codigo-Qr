...
<html>
  <head>
    ...
    <script  defer src="http://localhost/ojs-3.3.0-14/ojs-3.3.0-14/ModuloCertificado/js/certificado.js"></script>
    <script  src="http://localhost/ojs-3.3.0-14/ojs-3.3.0-14/ModuloCertificado/js/quere.js"></script>
  </head>
  <body>
    ...
    <main>
      <div class="container_main">
        ...
        <section class="publishers_signatures">     
          ...
          <!-- AQUI GENERO EL CODIGO QR -->
          <?php require_once 'certificado_qr_handler.php'; ?>
        </section>
